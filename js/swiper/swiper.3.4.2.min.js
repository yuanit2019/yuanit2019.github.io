(function(){var n={ieHtm1:function(){var t=$(window).height(),n='<div id="gs-warning-bg" style="width:100%;height:'+t+'px;position:fixed;left:0;top:0;_position:absolute;_top:expression(eval(document.documentElement.scrollTop));z-index:99999;background:#000;opacity:0.65;filter:alpha(opacity=65);"><\/div>';return n+='<div id="gs-warning-dialog" style="padding:40px 60px;width:400px;height:190px;font-size:14px;border-top:3px solid #e22200;position:fixed;left:50%;top:50%;margin:-132px 0 0 -260px; z-index:10000000;background:#262626;_position:absolute;_top:expression(eval(document.documentElement.scrollTop+300));">',n+='<p style="line-height:30px;color:#e5e5e5;font-size:18px;">您使用的浏览器版本过低，可能会影响到您浏览本页面，建议升级您的浏览器：<\/p>',n+='<a style=" text-decoration:none;display:inline-block;width:180px;height:60px;line-height:60px;color:#fff;font-size:18px;text-align:center;background:#e22200;margin-top:20px;" href="http://www.firefox.com.cn/" target="_balnk">火狐&nbsp;Firefox<\/a>',n+='<p style="width:100%;text-align:right;"><img style="width:auto" alt="" src="//image.gamersky.com/webimg15/logo/chang/160x53.png"><\/p>',n+='<a id="gs-warning-close" style="display:block;text-decoration: none;width:30px;height:30px;line-height:30px;color:#fff;font-size:20px;font-weight:700;text-align:center;background:#e22200;position:absolute;right:0;top:-3px;" href="javascript:void(0);">×<\/a>',n+"<\/div>"},ieHtm2:function(){var n='<div id="gs-warning-tips" style="width:100%;height:60px;font-size:14px;text-align:center;background:#262626">';return n+='<img style="vertical-align:middle;" src="//image.gamersky.com/webimg13/zhuanti/common/warning.png">',n+='<span style="font-size:18px;color:#e5e5e5;">&nbsp;您使用的浏览器版本过低，可能会影响到您浏览本页面，建议升级您的浏览器：&nbsp;&nbsp;<\/span>',n+='<a style=" display:inline-block;width:180px;height:60px;line-height:60px;color:#fff;font-size:18px;text-align:center;background:#e22200;text-decoration:none;" href="http://www.firefox.com.cn/" target="_balnk">火狐&nbsp;Firefox<\/a>',n+"<\/div>"},ieFun:function(t){t=$("#sbie").attr("data-n")||t;var i=$.browser.msie,r=parseInt($.browser.version);if(i&&r<=parseInt(t)){$("body").append(n.ieHtm1());$("#gs-warning-close").on("click",function(){$("#gs-warning-dialog,#gs-warning-bg").remove();$("body").prepend(n.ieHtm2())})}}};$(document).ready(function(){n.ieFun(8)})})();
(function(n){n.fn.Slide=function(t){return this.each(function(){var k,s=n(this),r=n.extend(t),d=r.effect,h=r.delayTime,g=r.autoPlay,rt=r.interTime,w=r.prevCell,v=r.nextCell,u=r.bigPic,c=r.smallPic,a,b;r="";var y=s.find(w),nt=s.find(v),f=s.find(u),l=f.find("li"),p=s.find(c),o=l.outerWidth(!0),e=l.length,i=0,tt=parseInt(y.css("left")),it=parseInt(y.width());for(u=0;e>u;u++)r+="<a href='javascript:;' class='"+(0==u?"cur":"")+"'><\/a>";0==p.length?f.after('<div class="'+c.replace(".","")+'">'+r+"<\/div>"):""==p.html()?p.html(r):i=p.find("a.cur").index();switch(d){case"fold":for(u=0;e>u;u++)0==u?l.eq(u).addClass("active").css({display:"list-item",position:"absolute",top:0,left:0}):l.eq(u).removeClass("active").css({display:"none",position:"absolute",top:0,left:0});break;case"leftLoop":f.find("li:first").hasClass("clone")||(u=f.find("li:first").clone().addClass("clone"),r=f.find("li:last-child").clone().addClass("clone"),f.css({width:o*e+2*o,position:"absolute",top:0,left:-(o+o*i)}).append(u).prepend(r))}a=function(n){switch(d){case"fold":l.stop(!1,!0).removeClass("active").fadeOut(h).eq(i).addClass("active").fadeIn(h,function(){$(this).find("img").attr("src",$(this).find("img").attr("data-src"))});s.find(c).find("a").removeClass("cur").eq(i).addClass("cur");break;case"leftLoop":""==n&&f.stop(!1,!0).animate({left:-(o+o*i)},h);".prev"==n&&f.stop(!1,!0).animate({left:-(o*(i==e-1?0:i+1))},h,function(){i==e-1&&f.css({left:-(o*e)})});".next"==n&&f.stop(!1,!0).animate({left:-(o+o*(i==e?e:0==i?e:i))},h,function(){0==i&&f.css({left:-o})});s.find(c).find("a").removeClass("cur").eq(i).addClass("cur");f.find("img").each(function(){$(this).attr("src",$(this).attr("data-src"))})}};b=function(){k=setInterval(function(){i==e-1?i=0:i++;a(v)},rt)};1==g&&b();s.on({mouseenter:function(){clearInterval(k);0>tt&&(y.stop().animate({left:0},200),nt.stop().animate({right:0},200))},mouseleave:function(){1==g&&b();0>tt&&(y.stop().animate({left:-it},200),nt.stop().animate({right:-it},200))}}).on("click",w,function(){i=0==i?e-1:i-1;a(w)}).on("click",v,function(){i=i==e-1?0:i+1;a(v)}).find(c).on("click","a",function(){0==n(this).hasClass("cur")&&(i=n(this).index(),a(""))})})}})(jQuery);$(function(){$("#Slide1").Slide({bigPic:".Bimg",smallPic:".Simg",autoPlay:!0,interTime:5e3,effect:"fold",delayTime:300,prevCell:".prev",nextCell:".next"})});
